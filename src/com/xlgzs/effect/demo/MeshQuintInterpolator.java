...
public class MeshQuintInterpolator implements Interpolator {
     ...
     */
    public MeshQuintInterpolator(byte mode) {
        if (mode > -1 && mode < 3) {
            _mode = mode;
        } else {
    ...
    public float getInterpolation(float input) {
        ...
        case INOUT:
            if ((input *= 2) < 1) return 0.5f * input * input * input * input * input;
